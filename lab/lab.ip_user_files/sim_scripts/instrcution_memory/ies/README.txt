...
#
# Generated by export_simulation on Sun May 22 18:05:09 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './instrcution_memory.sh' script.

./instrcution_memory.sh -reset_run
...
./instrcution_memory.sh -noclean_files

For more information on the script, please type './instrcution_memory.sh -help'.
